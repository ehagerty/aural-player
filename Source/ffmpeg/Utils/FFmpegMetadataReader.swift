...
class FFmpegMetadataReader {
    ...
    ///
    private func readAudioMetadata(_ fileCtx: FFmpegFileContext) -> [String: String] {
    ...
    ///
    private func readAudioInfo(_ fileCtx: FFmpegFileContext) -> FFmpegAudioInfo {
        ...
        return FFmpegAudioInfo(fileType: fileType, codec: codecName, duration: duration, sampleRate: sampleRate, sampleFormat: sampleFormat, bitRate: bitRate,
    ...
    ///
    private func readCoverArt(_ fileCtx: FFmpegFileContext) -> NSImage? {
