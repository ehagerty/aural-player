...
class PlayQueueViewDelegate: NSObject, NSTableViewDelegate, NSMenuDelegate {
    ...
    func tableView(_ tableView: NSTableView, viewFor tableColumn: NSTableColumn?, row: Int) -> NSView? {
        ...
        case .playQueue_listView_title:
            
            return createTextCell(tableView, .playQueue_listView_title, track, row)
            
        case .playQueue_listView_duration:
...
//        cell.rowSelectionStateFunction = {tableView.selectedRowIndexes.contains(row)}
    ...
    private func createDurationCell(_ tableView: NSTableView, _ text: String, _ row: Int) -> DurationCellView? {
        ...
        guard let cell = tableView.makeView(withIdentifier: .playQueue_listView_duration, owner: nil) as? DurationCellView else {return nil}
