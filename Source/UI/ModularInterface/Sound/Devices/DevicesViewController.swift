...
class DevicesViewController: NSViewController, NSTableViewDelegate, NSTableViewDataSource, NotificationSubscriber {
    
    override var nibName: String? {return "Devices"}
